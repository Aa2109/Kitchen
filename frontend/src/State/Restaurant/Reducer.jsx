...
const restaurantReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.GET_RESTAURANT_BY_USER_REQUEST:
    case actionTypes.CREATE_CATEGORY_REQUEST:
    case actionTypes.GET_RESTAURANTS_CATEGORY_REQUEST:
      return { ...state, loading: true, error: null };

    case actionTypes.CREATE_EVENTS_SUCCESS:
      return { ...state, loading: true, userRestaurants: action.payload };
    ...
    case actionTypes.GET_RESTAURANT_BY_ID_SUCCESS:
      ...
      case actionTypes.GET_RESTAURANT_BY_USER_SUCCESS:
      // case actionTypes.UPDATE_RESTAURANT_SUCCESS:
      // case actionTypes.UPDATE_RESTAURANT_STATUS_SUCCESS:
      // console.log("Payload received: ", action.payload);
        return { ...state, loading: false, userRestaurants: action.payload };

        case actionTypes.UPDATE_RESTAURANT_SUCCESS:
    case actionTypes.UPDATE_RESTAURANT_STATUS_SUCCESS:
      const updatedRestaurant = action.payload;
      const updatedUserRestaurants = state.userRestaurants.map(restaurant =>
        restaurant.id === updatedRestaurant.id ? updatedRestaurant : restaurant
      );
      return { ...state, loading: false, userRestaurants: updatedUserRestaurants };
